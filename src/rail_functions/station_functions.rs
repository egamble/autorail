...
data merge block *3* {front_text: {has_glowing_text: 1b, messages: [{"text":"*4*","color":"blue"},{"text":"*5*","color":"blue","click_event":{"action":"run_command","value":"***/x/station/name_sign {next_station_id:*6*}"}},{"text":"*7*","color":"blue"},{"text":"","color":"blue"}]}}"#.to_string();
