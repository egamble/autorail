...
fn build_station_sign_body(
  ...
  let mut body = r#"data merge block *1* {front_text: {messages: [{"text":"*2*","color":"dark_blue"},{"text":"*3*","color":"dark_blue","click_event":{"action":"run_command","value":"***/signs/*4*"}},{"text":"*5*","color":"dark_blue"},{"text":"*6*","color":"dark_blue"}]}}"#.to_string();
